...
@Mod(value = FattysOven.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods
// in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = FattysOven.MODID, value = Dist.CLIENT)
public class FattysOvenClient {
    public FattysOvenClient(ModContainer container) {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(
                FattysOven.OVEN_BLOCK_ENTITY.get(),
                OvenBlockRenderer::new);
    }

    public static void setupMenus(RegisterMenuScreensEvent evt) {
        evt.register(FattysOven.OVEN_INVENTORY.get(), OvenMenuScreen::new);
    }
}
